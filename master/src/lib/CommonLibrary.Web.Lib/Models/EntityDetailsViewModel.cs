...
namespace ComLib.Web.Lib.Models
{
    ...
    /// </summary>
    public class EntityDetailsViewModel : EntityBaseViewModel
    {
    ...
    public class EntityDetailsViewModel<T> : EntityDetailsViewModel where T : IEntity
    {
        ...
        public EntityDetailsViewModel(string controlPath, T entity, string editUrl, string deleteUrl, string indexUrl, bool allowEdit, bool allowDelete)
        {
